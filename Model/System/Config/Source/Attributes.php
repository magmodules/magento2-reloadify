...
namespace Magmodules\Reloadify\Model\System\Config\Source;
...
class Attributes implements ArrayInterface
{
    ...
    {
        $attributes = [];
        $attributes[] = ['value' => 'attribute_set_id', 'label' => __('Attribute Set ID')->render()];
        $attributes[] = ['value' => 'attribute_set_name', 'label' => __('Attribute Set Name')->render()];
        $attributes[] = ['value' => 'type_id', 'label' => __('Product Type')->render()];
        $attributes[] = ['value' => 'entity_id', 'label' => __('Product Id')->render()];
